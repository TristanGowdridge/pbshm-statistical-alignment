...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        ...
        NAVIGATION={
            "modules":{
                ...
                "Transfer Learning": "transferlearningOffline.population_list"
            }
        }
    )
    ...
    ## Transfer Learning
    from pbshm.transferlearning import transferlearningOffline
    app.register_blueprint(transferlearningOffline.bp, url_prefix="/transferlearning")
    #Set Root Page
